...
def is_there_collision(S, theta, Z, r):
    ...
    for i in range(8):
        for j in range(8):
            if i != j and i != j + 1 and i != j - 1 and are_spheres_colliding(spheres[i], spheres[j], r, r):
                collision = True
                print(i, j)
    return collision
################################################################################
...
def collision_detection(clientID, joint_handles, S, M):
    ...
    """
    theta = np.array([[0, 0, 0.1, -2.79731025, -0.58787870,  -0.44194958, 1.96679567, -0.50628958, -0.73656183, 3.07307548,  -0.75577025, 2.61955754, -2.98117356, -2.02637222, 2.28347010],
                      [0, 0, 0, -2.83169392, 2.03224449,  -1.60210153, 1.32916788, 0.04697692, 0.93594889, 1.44425167, 0.64014588,  1.90738626, 0.82377931, 1.68504340, -1.27063583],
                      [3.14, 1.5, 0, 2.89098458, -1.53616482,  1.39426828, -1.31211022, 0.72504312, -2.66573670, 1.60842364,  -0.70850489, 1.92804871, 1.66946648, 1.89600887, -3.05891633],
                      [0, 0, 0, 1.11516925, 1.92858218,  -2.39406817, -1.59167495, -2.30805406, 1.86735032, -1.28435563,  0.03837304, -0.98940773, -1.75350804, -0.99173644, 0.63209242],
                      [0, 0, 0, -0.19769979, -0.80217197,  2.83709552, 0.45808503, 0.19727700, -0.20277843, -1.03783602,  -0.74450504, -1.33345165, 1.38693544, 1.32363642, 2.08453226],
                      [0, 0, 0, 2.00281437, 2.94526677,  -2.61141333, -0.70320318, 2.86590535, 1.51860879, 0.94631448,  2.22162506, 1.85177936, 1.44784656, -2.26096654, 1.03104158]])
    r = 0.05
